...
export const MainTab = (props) => {
  ...
  return (
    <div className="w-[65px] h-full bg-blue-600  pt-6 relative">
      ...
      <div
        className="w-full pb-2 cursor-pointer flex justify-center items-center"
        onClick={(e) => {
      ...
      <div
        ref={refInfo}
        className="absolute w-[300px] text-left border hidden z-10
      ...
      >
        ...
        <div className="w-full py-1">
          <div
            className="w-full py-1  px-3 cursor-pointer hover:bg-zinc-100"
            onClick={() => {
              props.openInfo(1);
              refInfo.current.style.display = "none";
            }}
      ...
      <div className="w-full cursor-pointer ">
        <div
          className={
            active === "message"
              ? "h-[65px] flex justify-center items-center bg-blue-700"
