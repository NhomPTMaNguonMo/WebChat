...
import __dirname, { clearCookie, cookieAdmin, hash, IP } from "./confi.js";
...
export function valiAdmin(req:express.Request,res:express.Response,next:express.NextFunction) {
    var cookie:cookieAdmin=req.cookies
    var date=new Date()
